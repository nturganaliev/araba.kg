...
//            'template' => '<div class="col-sm-8 col-md-8 col-lg-8">{label}{input}{error}{hint}</div>'
                ...
                ])->dropDownList(ArrayHelper::map(CarType::getWheelsByType(Car::CAR_TYPE_AUTOMOBILE), 'id', 'tname'), [
                    'prompt' => yii::t('app', 'Select ...')
                ])->error(false);
                ?>
            </div>
    ...
    <div class="col-sm-24">
        <div class="form-group">
            <div class="row">
                ...
                ])->dropDownList(ArrayHelper::map(CarType::getKuzovsByType(Car::CAR_TYPE_AUTOMOBILE), 'id', 'tname'), [
                    'prompt' => yii::t('app', 'Select ...')
                ])->error(false);
                ?>
                ...
                ])->dropDownList(ArrayHelper::map(CarType::getPrivodsByType(Car::CAR_TYPE_AUTOMOBILE), 'id', 'tname'), [
                    'prompt' => yii::t('app', 'Select ...')
                ])->error(false);
                ?>
                ...
                ])->dropDownList(ArrayHelper::map(CarType::getTransmissionsByType(Car::CAR_TYPE_AUTOMOBILE), 'id', 'tname'), [
                    'prompt' => yii::t('app', 'Select ...')
                ])->error(false);
                ?>
            </div>
    ...
    <div class="col-sm-24">
        <div class="form-group">
            <div class="row">
                ...
                ])->dropDownList(ArrayHelper::map(CarType::getEnginesByType(Car::CAR_TYPE_AUTOMOBILE), 'id', 'tname'), [
                    'prompt' => yii::t('app', 'Select ...')
                ])->error(false);
                ?>
                ...
                ])->dropDownList(ArrayHelper::map(common\models\CarType::getColorsByType(common\models\Car::CAR_TYPE_AUTOMOBILE), 'id', 'tname'), [
                    'prompt' => yii::t('app', 'Select ...')
                ])->error(false)
                ?>
            </div>
    ...
    <div class="form-group">
        ...
        <?php
        $sets = ArrayHelper::map(CarType::getCompleteSetsByType(Car::CAR_TYPE_AUTOMOBILE), 'id', 'tname');
        asort($sets);
        ...
        <div class="form-group">
            ...
            echo $form->field($model, 'images[]', [
                ...
                'pluginOptions' => [
                    'showUpload' => false,
//                    'uploadUrl' => \yii\helpers\Url::to(['/site/image-upload']),
                    'fileUpload' => false,
                    'showDelete' => true,
