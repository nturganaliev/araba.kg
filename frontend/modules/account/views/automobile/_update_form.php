...
//            'template' => '<div class="col-sm-8 col-md-8 col-lg-8">{label}{input}{error}{hint}</div>'
                ...
                $form->field($model, 'model_id', [
                    ...
                    'data' => ($model->marka_id == null) ? [] : ArrayHelper::map(common\models\CarModel::findMergedNames($model->marka_id), 'id', 'name'),
                    'pluginOptions' => [
                        'depends' => ['marka-id'],
                        'placeholder' => yii::t('app', 'Select...'),
    ...
    <div class="col-sm-24">
        <div class="form-group">
            <div class="row">
                ...
                ])->dropDownList(ArrayHelper::map(CarType::getColorsByType(Car::CAR_TYPE_AUTOMOBILE), 'id', 'tname'), [
                    'prompt' => yii::t('app', 'Select ...')
                ])->error(false)
                ?>
            </div>
