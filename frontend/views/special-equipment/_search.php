...
<div class="car-search">
    ...
    $form = ActiveForm::begin([
            'id' => 'sq-search-form',
            'action' => ['/car', 'type' => common\models\Car::CAR_TYPE_SPECIAL_EQUIPMENT],
            'method' => 'get',
            'fieldConfig' => [
                'template' => "{label}\n{beginWrapper}\n{input}\n{hint}\n{error}\n{endWrapper}",
            ],
...
//            'options' => ['id' => 'sq-model-id', 'placeholder' => yii::t('app', 'All models'),],
...
//        ]);
        ...
        ])->textInput(['placeholder' => Yii::t('app', 'All special equipment models')]);
        ?>
        <div class = "col-lg-offset-6 col-lg-6 col-md-6 col-sm-6">
            <label class="control-label">&nbsp;</label>
            <?php echo Html::submitButton(Yii::t('app', 'Search') . ' <span style="color:orange;" class="fa fa-angle-double-right fa-lg">', ['class' => 'btn btn-default form-control']) ?>
        </div>
        <div class="col-xs-24">
            <?=
            Html::a(Yii::t('app', 'Detailed search'), ['/car', 'type' => common\models\Car::CAR_TYPE_SPECIAL_EQUIPMENT, 'rent' => $rent], [
