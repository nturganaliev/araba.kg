...
//        ])->label(false);
        ...
        ])->textInput(['placeholder' => Yii::t('app', 'All motocycle models')])->label(false);
    ...
    <div class="form-group">
        ...
        ])->dropDownList(ArrayHelper::map(\common\models\Engine::getByCarType(Car::CAR_TYPE_MOTOCYCLE), 'id', 'tname'), [
    ...
    <div class="form-group">
        ...
        ])->dropDownList(ArrayHelper::map(\common\models\Transmission::getByCarType(Car::CAR_TYPE_MOTOCYCLE), 'id', 'tname'), [
        ...
        ])->dropDownList(ArrayHelper::map(\common\models\Color::getByCarType(Car::CAR_TYPE_MOTOCYCLE), 'id', 'tname'), [
