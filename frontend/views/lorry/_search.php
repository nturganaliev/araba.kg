...
//            'options' => ['id' => 'lorry-model-id', 'placeholder' => yii::t('app', 'All models'),],
...
//        ]);
        ...
        ])->textInput(['placeholder' => Yii::t('app', 'All lorry models')]);
...
//        echo '-';
    ...
    <div class="form-group">
        ...
        <div class="col-xs-24">
            <?=
            Html::a(Yii::t('app', 'Detailed search'), ['/car', 'type' => common\models\Car::CAR_TYPE_LORRY], [
