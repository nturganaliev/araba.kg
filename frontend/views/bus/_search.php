...
//        ]);
        ...
        ])->textInput(['placeholder' => Yii::t('app', 'Bus models')]);
...
//        echo '-';
    ...
    <div class="form-group">
        ...
        ])->dropDownList(ArrayHelper::map(Kuzov::getByCarType(Car::CAR_TYPE_BUS), 'id', 'tname'), [
        ...
        <div class="col-xs-24">
            <?=
            Html::a(Yii::t('app', 'Detailed search'), ['/car', 'type' => common\models\Car::CAR_TYPE_BUS], [
