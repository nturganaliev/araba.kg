 ...
 */
class LorryQuery extends Lorry
{
    ...
    public $priceFrom;
    public $priceTo;
    public $type_id = Car::CAR_TYPE_LORRY;
    public $model_name;
    ...
    public function search($params)
    {
        ...
        $query->joinWith(['carModel' => function ($q) {
                ...
                $q->joinWith(['marka' => function($qi) {
                        $qi->where(['markas.car_type_id' => Car::CAR_TYPE_LORRY]);
                    }
                        ], true, 'INNER JOIN');
                }], true, 'INNER JOIN');
    ...
    public function attributeLabels()
    {
        return [
            ...
            'model_name' => Yii::t('app', 'Lorry model'),
        ];
    }
}
