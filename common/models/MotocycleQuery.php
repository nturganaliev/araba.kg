 ...
 */
class MotocycleQuery extends Motocycle
{
    ...
    public $priceFrom;
    public $priceTo;
    public $type_id = Car::CAR_TYPE_MOTOCYCLE;
    public $model_name;
    ...
    {
        return [
            [['id', 'type_id', 'marka_id', 'moto_type_id', 'model_id', 'wheel_id', 'privod_id', 'transmission_id', 'engine_id', 'color_id', 'state_id', 'region_id', 'run_length', 'created_by', 'updated_by'], 'integer'],
    ...
    public function search($params)
    {
        ...
        $query->joinWith(['carModel' => function ($q) {
                ...
                $q->joinWith(['marka' => function($qi) {
                        $qi->where(['markas.car_type_id' => Car::CAR_TYPE_MOTOCYCLE]);
                    }
                        ], true, 'INNER JOIN');
                }], true, 'INNER JOIN');
    ...
    public function attributeLabels()
    {
        return [
            ...
            'model_name' => Yii::t('app', 'Motocycle model'),
        ];
    }
}
